...
//	optimizer->estimatePose(source, target, estimatedPose);
    ...
    // NELI MARK: - program crashes when `delete optimizer` is called (mac only issue?)
//    delete optimizer;
...
//	}
	...
	while (sensor.processNextFrame() && i <= iMax) {
        ...
        // NELI MARK: - From Excerse 5 - uncomment if needed
//		optimizer->estimatePose(source, target, currentCameraToWorld); // STEP 2. call estimatePose(_,_,_)
